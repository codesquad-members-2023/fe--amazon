...
var openSideBar = function openSideBar() {
  ...
  var sideMenu = element[0],
    openButton = element[1];
...
var hideSideBar = function hideSideBar() {
  ...
  var sideMenu = element[0],
    openButton = element[1];
  var closeButton = document.querySelector('.side-menu__close');
...
var openAllItems = function openAllItems() {
  ...
  var allItems = element[0],
    allItemsButton = element[1];
  allItemsButton.addEventListener('click', function () {
    allItems.style.transform = 'scaleY(1)';
  });
};
var closeAllItems = function closeAllItems() {
  for (var _len4 = arguments.length, element = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
    element[_key4] = arguments[_key4];
  }
  var simpleItemsButton = element[0],
    allItems = element[1];
  simpleItemsButton.addEventListener('click', function () {
    allItems.style.transform = 'scaleY(0)';
  });
};
var moveMain = function moveMain() {
  for (var _len5 = arguments.length, element = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
    element[_key5] = arguments[_key5];
  }
  var sideMain = element[0],
    sideMenuDetail = element[1];
  var backMainButton = document.querySelector('.back__main');
...
var actSideBar = function actSideBar() {
  var sideMenu = $('.side-menu');
  var openButton = $('.all-menu');
  var sideMain = $('.side-menu__main');
  var sideMenuDetail = $('.side-menu__detail');
  var simpleItemsButton = $('.side-menu__hide-button');
  var allItems = $('.side-menu__all-items');
  var allItemsButton = $('.side-menu__show-button');
...
//# sourceMappingURL=/sideBar.ba4af53c.js.map